...
const InfoView = () => {
    ...
    useEffect(() => {
        const userAgent = navigator.userAgent;
            if (/Android|BlackBerry|IEMobile|Opera Mini/i.test(userAgent)) {
                setType("android");
    ...
    return type==="ios"?(<Container>

        <Center mt="md" style={{
            marginLeft: 0,
            marginRight: 0,
        }}>
            <Image src={"IX.png"} height={100}
            ...
            >
                ...
                <Container style={{
                    ...
                    <p style={{
                        ...
                        “InnoX" uygulaması yalnızca en son Android 7.0 Nougat ile çalışan  ve daha yeni modellerde Chrome ile uyumludur.
                    </p>
                </Container>
                <Container>
                    <Text style={{
                        ...
                        <span>{' butona dokunun ve "'} </span>
                        <CiSquarePlus />
                        <span>{' Ana ekrana ekle"yin. '}</span>
                    </Text>
                </Container>
